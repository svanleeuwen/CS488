...
function makeUpperBody(rootnode)
    upperBody = gr.joint('upper body', {-30, 0, 45}, {0, 0, 0})
    rootnode:add_child(upperBody)
...
function makeLowerBody(rootnode)
    lowerBody = gr.joint('lower body', {-60, 0, 10}, {0, 0, 0})
    rootnode:add_child(lowerBody)
...
makeUpperBody(rootnode)
makeLowerBody(rootnode)
